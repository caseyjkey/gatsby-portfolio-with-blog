...
import { ANIMATION_CONFIG, TIMING, SECONDARY_DELAYS, ACCORDION } from '../../animations/config'
...
function Resume(props) {
  ...
  const [animatedEntries, setAnimatedEntries] = useState<Record<string, Set<number>>>({
    '1': new Set(),
    '2': new Set(),
    '3': new Set(),
    '4': new Set(),
  ...
  const updateAnimatedEntries = (accordionId: string, entryIndex: number) => {
  ...
  const handleToggle = (id: string) => {
    ...
    setTimeout(() => {
      ...
      console.log('Scrolling to headerId:', headerId);
      if (headerId) {
            ...
            <AccordionItem>
              <Page name="education">
                ...
                <AnimatedAccordionBody
                  ...
                  animatedEntries={animatedEntries['1']}
                  updateAnimatedEntries={updateAnimatedEntries}
                >
            ...
            <AccordionItem>
              <Page name="experience">
                ...
                <AnimatedAccordionBody
                  ...
                  isOpen={open === '2'}
                  isScrolling={isScrolling}
                  animatedEntries={animatedEntries['2']}
                  updateAnimatedEntries={updateAnimatedEntries}
                >
            ...
            <AccordionItem>
              <Page name="awards">
                ...
                <AnimatedAccordionBody
                  ...
                  isOpen={open === '3'}
                  isScrolling={isScrolling}
                  animatedEntries={animatedEntries['3']}
                  updateAnimatedEntries={updateAnimatedEntries}
                >
                  <Entry icon={GoStar}
                    style={{ marginTop: "10px" }}
            ...
            <AccordionItem>
              <Page name="leadership" className="mb-0">
                ...
                <AnimatedAccordionBody
                  ...
                  isOpen={open === '4'}
                  isScrolling={isScrolling}
                  animatedEntries={animatedEntries['4']}
                  updateAnimatedEntries={updateAnimatedEntries}
                >
