        ...
        <SittingSvg version="1.1" viewBox="-100 0 460 440" data-name="Layer 1">
          ...
          <g id="body">
            ...
            <g id="head">
              ...
              <g id="hair">
                <g id="sides">
                  <path d="M84.4,67c0,0-5.9,10-9,13.8c0,0,3.9,26.7-1.7,32.6c0,0-0.8-2.4-2.6-5.4c-1.8-3.1-6.5-37.2-4.7-42.3s6.1-13.8,12-12.8C84.4,54,84.4,67,84.4,67z" fill="#000000"></path>
                  <path d="M164,114.4l0.1,0.1c0,0,6.8-27.6,6-36.6s-3.3-18.7-5.1-21.7c-1.8-3.1-10.7-5.6-12-2.8c-1.3,2.8-6.1,9-6.1,9s12.5,12,13,14.8c0.4,2.1,0.5,15.3-0.1,24.2C159.4,106.2,160.9,110.9,164,114.4z" fill="#000000"></path>
                </g>
                <g id="stripe">
                  <path d="M72.9,59.6c0,0,33.5,22.5,72.7,7.7c0,0,17.4-1.8,22.3-11.8c0,0-6.1,1-7.2,1c-1,0,4.6-6.7,4.9-16.9c0.3-10.2-3.3-13.6-3.3-13.6s-5.9,10-10.5,11c0,0,2.6-8.7,2.3-13.3s0-6.1,0-6.1s-8.2,12-36.8,13.8c-28.7,1.8-39.1,3.1-43.2,7.7c-4.1,4.6-4.1,12.8-3.3,15.6S72.9,59.6,72.9,59.6z" fill="#000000"></path>
                </g>
              </g>
              <g id="eyeb">
                <path d="M84.6,92c0,0,16.8-9.6,14.2-12.2C96.2,77.2,84.6,92,84.6,92z" fill="#000000"></path>
                <path d="M151.5,91.5c0,0-16.8-9.6-14.2-12.2C139.9,76.8,151.5,91.5,151.5,91.5z" fill="#000000"></path>
              </g>
              <g id="eyey2">
                <circle r="5" cy="114" cx="98.4" fill="#000000"></circle>
                <circle r="5" cy="114" cx="136.9" fill="#000000"></circle>
              </g>
            </g>
            <g id="shirt">
              <path id="path119" d="M137.9,174.8c0,0,35.4,13.8,38.3,40.9l-11,11.5c0,0-0.5,67.7,1.9,71.6c0,0-20.1,12.2-33.3,15.1s-40-2.2-43.1-3.6c-3.1-1.4-15.3-10.8-15.3-10.8s2.6-9.8,2.4-13.9c-0.2-4.1,0.5-27.5,0.2-31.8c-0.2-4.3-1.2-19.9-1.2-19.9l-15.3-14.4c0,0,7.6-41.2,38.7-42.3c0,0,13,15.5,15.6,15.5s3.1,6.2,3.1,6.2s3.1-6.3,11-15.2z"></path>
            ...
            <g id="notebook">
              ...
              <rect id="rect1150" rx="3" width="15" height="15" x="-92.187965" y="245.78786" transform="rotate(-45)"></rect>
            </g>
            <g id="legs">
              <path id="path186" d="M15.7,303.3c0,0-1.9-11.2,8-15c9.9-3.8,37,3.2,64.8,18.5c27.8,15.3,69.9-5.1,98-14.7c28.1-9.6,45.9-10.1,49.3,0.9c0,0-24.7,39.3-45.5,40.6s-48.2-1-48.2-1l-31.9,0.6c0,0-24.3,8.6-28.7,8.3C77,341.2,20.8,325.3,15.7,303.3z" fill="#212121"></path>
              <path id="path190" d="M91.2,333.1c0,0,20.3-12,21.9-11.5c1.6,0.5,6.9,5.9,9.1,6.9c2.2,1,1.6,3.7,1.6,3.7l-3,9.3l-22.3-1.9L91.2,333.1z" fill="#2B2B2B"></path>
              ...
              <path d="M135.7,326.9l-1,27.8c0,0,55.2-2.9,87.4-33.8s2.2-37,2.2-37s-10.2-0.6-10.2,1.3C214.2,287,191.9,319.9,135.7,326.9z" fill="#000000"></path>
              ...
              <path d="M130.9,361c0.9-0.2-1.6-23.3-1.6-23.3s-68.3-5.1-98.3-45.6h0c-1.5-2.9-6.7-5.8-9.3-3.9l-2.3,1c-8.7,6.3-7.5,19.3-1.7,28.4c3.1,4.8,7.6,10.1,14.3,15.3C53.4,349.5,88.8,368.7,130.9,361z" fill="#000000"></path>
              <polygon points="157.2,358.6 149.4,357.8 146.4,347.8 155.8,347.3" fill="#EAEAEA"></polygon>
              <path id="path240" d="M150.9,347c-0.7-0.5,12.3-10.4,13.4-10.2c1.1,0.2,11.6,9.4,12.8,9.4c1.1,0,27.8,8.5,25.2,16.4l-25.5-0.6l-19.9-1.1C156.8,360.9,155.3,350.7,150.9,347z" fill="#2B2B2B"></path>
            </g>
          </g>
